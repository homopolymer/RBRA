...
The repository `RBRA_Test<https://github.com/homopolymer/RBRA_Test/>`_ contains data and script to test whether RBRA installs and works correctly. Download test data and run the following codes for test::
